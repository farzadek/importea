Titles = {
    ...
    "header": {
        ...
        "registerNow": ["Register now", "Inscription maintenant"],
    ...
    "footer": {
        ...
        "copyRight": ["All right reserved, Importea 2019", "Tous droits réservés, Importea 2019"],
        "politique": ["Privacy policy", "Politique de confidentialité"]
    },
    "rightBox": {
    ...
    "section4": {
        "howCanHelp": ["How can we help you?", "Comment pouvons nous vous aider?"],
        "dropALine": ["Drop us a line", "Contactez-nous"],
    ...
    "index": {
        ...
        "price": ["Price", "Prix"],
        "total": ["Total", "Total"],
        "sousTotal": ["Subtotal", "Sous-total"],
        "confirm": ["Confirm", "Confirmer"],
        "products": ["products", "produits"],
        "passwordConfirm": ["Password confirmation", "Confirmation du mot de passe"],
        "address": ["Address", "Adresse"],
        "phoneNo": ["Phone number", "Numéro de téléphone"],
        "back": ["back", "retour"],
        "credit": ["credit", "crédit"],
        ...
        "postCost": ["Post cost", "Frais postaux"],
        "payable": ["payable", "payable"],
        "achat": ["Purchase", "Achat"],
        "purchaseDate": ["purchase date", "date d'achat"],
        "payed": ["Payed", "payé"],
        "save": ["save", "sauvegarder"],
        "client": ["client", "client"],
        "tax": ["tax", "tax"],
        "pendingPurchase": ["Pending purchases", "List d'achats"],
        "pCode": ["P.code", "C.postal"],
        "city": ["City", "Ville"],
        "province": ["Province", "Province"],
    ...
    "purchase": {
        ...
        "howPayText1": ["Please pay the amounts below", "Veuillez payer le montant suivant"],
        "howPayText2": ["by Interac transfer within 3 days to email address", "par transfert Interac dans les 3 prochains jours à l'adresse électronique"],
    ...
    "showFacteurModal": {
        ...
        "waitMoney": ["You haven't paid yet?", "Vous n 'avez pas encore payé?"],
